...
object DemoData {
    ...
    val sncf: Sample get() = Sample(
        ...
        gps = """{"success":true,"fix":true,"timestamp":1711965000000,"latitude":45.05,"longitude":5.20,
            "altitude":356.63,"speed":82.7,"heading":120.5}""",
        details = """{"stops":[
            {"name":"Paris Gare de Lyon","label":"PARIS GARE DE LYON","coordinates":{"latitude":48.8443,"longitude":2.3744},"delay":0,"isDelayed":false,
             "theoricDate":"${at(-92, true)}","realDate":"${at(-92, true)}",
             "progress":{"traveledDistance":0,"remainingDistance":0}},
            {"name":"Lyon Part-Dieu","label":"LYON PART DIEU","coordinates":{"latitude":45.7605,"longitude":4.8596},"delay":0,"isDelayed":false,
             "theoricDate":"${at(-12, true)}","realDate":"${at(-12, true)}",
             "progress":{"traveledDistance":465000,"remainingDistance":0}},
            {"name":"Valence TGV","label":"VALENCE TGV","coordinates":{"latitude":44.9915,"longitude":4.9789},"delay":5,"isDelayed":true,
             "theoricDate":"${at(7, true)}","realDate":"${at(12, true)}",
             "progress":{"traveledDistance":98000,"remainingDistance":6000}},
            {"name":"Grenoble","label":"GRENOBLE","coordinates":{"latitude":45.1915,"longitude":5.7143},"delay":5,"isDelayed":true,
